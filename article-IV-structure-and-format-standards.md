<!--
document_type: constitutional-article
title: "Article IV: Structure & Format Standards"
status: draft
owner: article-iv-drafting-committee
audience: [human-authors, agent-consumers, documentation-maintainers]
...
|---|---|---|
| `document_type` | string | Classification per [Article II: Document Types & Taxonomy](article-II-document-types-and-taxonomy.md) |
...
Frontmatter is the structural contract between the document and every system that consumes it — search indexes, linters, agents, and dashboards. Documents missing required fields SHALL fail CI validation, as governed by Article VI.
